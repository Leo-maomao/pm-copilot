...
| File write | Generated PRD, tracking plan, prototype, package | File paths created | Return content inline if writing is unavailable |
| Mermaid rendering | Flow validation | Diagram source | Keep raw Mermaid if rendering is unavailable |
