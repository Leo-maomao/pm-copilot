...
- UI deliverable reference when the scenario is user-facing: evidence-based prototype, specification, or `outputs/<run-id>/prototype-<platform>.html` with visible fidelity limits
