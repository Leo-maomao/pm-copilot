...
- For repo-backed UI prototypes, read the real host frontend code and assets, keep host production files read-only by default, and generate an isolated HTML demo that mirrors the current surface with only the requested feature added.
