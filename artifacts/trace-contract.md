...
- Record `loop_state` after every iteration and `loop_summary` before final delivery. The summary stop reason must match success, input, blocker, budget, no-progress, human-checkpoint, or failure evidence.
