...
- Structure every requirement detail with `用户与场景`、`需求入口`、`需求详情`、`设计与交互`、`图示`; merge related rules into these field/value rows rather than expanding one topic into many fields.
