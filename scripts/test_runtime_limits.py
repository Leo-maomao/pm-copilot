...
from runtime_limits import (
    ...
    DEFAULT_INTERACTIVE_IDENTICAL_FAILURE_LIMIT, DEFAULT_INTERACTIVE_MAX_REVISIONS,
    DEFAULT_INTERACTIVE_TIMEOUT_MINUTES, DEFAULT_LOOP_MAX_ITERATIONS,
...
class RuntimeLimitsTests(unittest.TestCase):
    def test_defaults_preserve_existing_workflow_contracts(self) -> None:
        ...
        self.assertEqual(DEFAULT_INTERACTIVE_TIMEOUT_MINUTES, 60)
        self.assertEqual(DEFAULT_INTERACTIVE_MAX_REVISIONS, 3)
        self.assertEqual(DEFAULT_INTERACTIVE_IDENTICAL_FAILURE_LIMIT, 2)
