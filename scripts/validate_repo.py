...
REQUIRED_FILES = [
    ...
    "scripts/validate_agent_task_ledger.py",
    ...
    "scripts/test_agent_task_ledger.py",
    "scripts/prd_evidence_upgrade.py",
    "scripts/test_prd_evidence_upgrade.py",
    "scripts/test_agent_collaboration_trace.py",
    "scripts/test_upgrade_local_outputs.py",
    "scripts/test_sync_embedded_copies.py",
...
REQUIRED_TEXT_TOKENS = {
    ...
    "artifacts/artifact-contracts.md": [
        ...
        "tool-results",
        "Optional Exports",
        "PRD screenshots are real local evidence",
    ],
    "artifacts/tool-result-contract.md": [
        "tool_id:",
        "status:",
    ...
    "skills/prd-writing/SKILL.md": ["Treat a screenshot as evidence, not decoration"],
    "artifacts/prd-contract.md": ["Evidence and Writing Reliability"],
    "docs/implemented-feature-prd-workflow.md": [
        "Output Folder",
        "render_prd_html.py",
        "Screenshot Rules",
