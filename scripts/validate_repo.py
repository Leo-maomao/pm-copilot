...
REQUIRED_FILES = (
    ...
    "scripts/prd_delivery_engine.py", "scripts/render_prd_html.py", "scripts/setup_prd_renderer.py",
    "scripts/validate_outputs.py", "scripts/prd_visual_contract.py",
    "scripts/validate_agent_trace.py", "scripts/generate_reconstructed_figure.py",
    "scripts/capture_frontend_figure.py", "scripts/prd_manager.py", "scripts/refresh_codex_plugin.py",
...
REMOVED_PATHS = (
    ...
    "scripts/agent_runtime.py", "scripts/collect_implemented_feature_evidence.py",
    "scripts/delivery_failure_guard.py", "scripts/inspect_host_frontend.py",
    "scripts/project_workspace.py", "scripts/revision_scope.py",
    "scripts/run_delivery_checks.py", "scripts/specialist_dispatch.py",
)
