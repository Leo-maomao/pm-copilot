...
| 需求详情 | 一、角色变更流程<br>1. 管理员修改高危角色。<br>2. 系统展示确认信息。<br>3. 管理员确认后完成变更。<br><br>二、状态与边界<br>1. 保存中显示加载。<br>2. 无权限用户不可操作。<br>3. 保存错误时保留原角色并允许重试。<br>4. 成员为空时展示空状态。 |
...
## 六、多语言需求""",
    ...
    run_case(
        ...
        PASS_PRD.replace(
            "一、角色变更流程<br>1. 管理员修改高危角色。<br>2. 系统展示确认信息。<br>3. 管理员确认后完成变更。<br><br>二、状态与边界<br>1. 保存中显示加载。<br>2. 无权限用户不可操作。<br>3. 保存错误时保留原角色并允许重试。<br>4. 成员为空时展示空状态。",
