...
7. Stop before a `Ready for engineering` PRD/prototype delivery if any engineering-blocking `must confirm before development or launch` item is unanswered.
...
- Pre-development confirmations are resolved before the PRD is marked ready for engineering.
